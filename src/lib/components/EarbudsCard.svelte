<!-- src/lib/components/EarbudsCard.svelte -->
<script lang="ts">
...
<<<<<<< BETA
        ...
        <div class="flex items-center justify-between mt-4">
          ...
          <a href={`/product_list/product_detail/${slug}`}
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="mt-3 space-y-2 text-[1.15rem] text-gray-700 font-medium">
          <p class="flex justify-between">
            <span>Bluetooth</span>
            <span class="text-[#00332e] font-semibold">{bluetooth}</span>
          </p>
          <p class="flex justify-between">
            <span>Battery</span>
            <span class="text-[#00332e] font-semibold">{battery}</span>
          </p>
          <p class="flex justify-between">
            <span>Price</span>
